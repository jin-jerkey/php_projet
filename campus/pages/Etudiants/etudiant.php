...
<body>
    ...
    <aside>
        ...
        <div class="user-info">
            ...
            <button type="button" onclick="confirmLogout()">Déconnexion</button>
            <script>
        ...
        <div class="container">
          ...
          <div id="myModal" class="modal">
            ...
            <form class="my-form" method="post" action="create.php" enctype="multipart/form-data">
              ...
              <div class="input__wrapper">
                  <input type="number" id="HA" name="HA" class="input__field" placeholder="Heures d'absences" required autocomplete="off" value="00">
              ...
              <div class="input__wrapper">
                  <span id="identifiant">
                      <input type="text" id="qrcode" name="id_qr" class="input__field" placeholder="QR Code" required autocomplete="off">
                  </span>
               </div>
              <div class="input__wrapper">
                ...
                <?php
                  ...
                  try {
                      ...
                      while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                          echo "<tr>";
                          echo "<td>" . $counter++ . "</td>";
                          echo "<td><img src='{$row['profil']}' width='100' alt='Image de profil'></td>";
                          echo "<td><img src='{$row['id_qr']}' width='100' alt='Image de profil'></td>";
          ...
          <div id="absentStudentsContent" style="display:none;">
            ...
            <tbody>
                ...
                <tr style="border-bottom: 3px solid; border-right: 3px solid; border-left: 3px solid; border-color: #6b6fd2;">
                    ...
                    <td>Cabrel</td>
                    <td>
                      <button class="action-button">23H✔</button></td>
                    <td>
                      <a href="profil.php">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M12 4.5C7.5 4.5 3.737 7.252 2 12c1.737 4.748 5.5 7.5 10 7.5s8.263-2.752 10-7.5c-1.737-4.748-5.5-7.5-10-7.5zm0 13c-2.761 0-5-2.239-5-5s2.239-5 5-5 5 2.239 5 5-2.239 5-5 5zm0-8.5c-1.93 0-3.5 1.57-3.5 3.5s1.57 3.5 3.5 3.5 3.5-1.57 3.5-3.5-1.57-3.5-3.5-3.5z" fill="currentColor"/>
                        </svg>
                      </a>
                    </td>
                </tr>

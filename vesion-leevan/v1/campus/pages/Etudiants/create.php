...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $sql = "INSERT INTO etudiant (matricule, Nom, Prenom, dateofbirth, telephone, filiere, niveau, id_qr, profil,mot_de_passe)
                VALUES (:matricule, :nom, :prenom, :dateofbirth, :telephone, :filiere, :niveau, :id_qr, :profil, :mot_de_passe)";

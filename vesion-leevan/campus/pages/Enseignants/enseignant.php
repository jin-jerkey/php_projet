          ...
          <form action="" method="post">
            ...
            <select id="class-select" name="discipline">
                ...
                <option value="Algorithme et complexite" >Algorithme et complexite</option>
                      ...
                      <option value="Gestion de carriere professionnelle" >Gestion de carriere pro</option>
                      <!-- Autres options -->
            </select>
            <label for="class-select" style="font-family: Arial sans-serif; font-weight: bold; text-transform: uppercase;">Departement</label>
            <select id="class-select" name="departement">
                <option  value="">ALL</option>

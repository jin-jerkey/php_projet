        ...
        if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
            ...
            if ($check !== false) {
                if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
                    $sql = "INSERT INTO enseignant (matricul, nom, prenom, telephone, email, date_nais, bureau, departement, discipline, image) 
                            VALUES (:matricul, :nom, :prenom, :telephone, :email, :date_nais, :bureau, :departement, :discipline, :image)";

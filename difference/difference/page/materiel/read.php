    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        if(mysqli_stmt_execute($stmt)){
            ...
            if(mysqli_num_rows($result) == 1){
                ...
                $nom = $row["Description"];
                $nom = $row["Quantite_Disponible"];
                $nom = $row["Statut"];
                $nom = $row["Emplacement"];
                $nom = $row["ID_Categorie"];
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <p><b><?php echo $row["Nom_Materiel"]; ?></b></p>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <p><b><?php echo $row["Quantite_Disponible"]; ?></b></p>
                    </div>
                    <div class="form-group">
                        <label>Statut</label>
                    ...
                    <div class="form-group">
                        ...
                        <p><b><?php echo $row["Emplacement"]; ?></b></p>
                    </div>
                    <div class="form-group">
